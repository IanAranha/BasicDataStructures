...
// Since arrays can be changed, or mutated, at any time, there is no guarantee 
// about where a particular piece of data will be on a given array, or if that element 
// still exists. Luckily, JavaScript provides us with another built-in method, 
// indexOf(), that allows us to quickly and easily check for the presence 
// of an element on an array. indexOf() takes an element as a parameter, and when 
// called, it returns the position, or index, of that element, or -1 if the element 
...
// 	We have defined a function, quickCheck, that takes an array and an element 
// as arguments. Modify the function using indexOf() so that it returns true if the 
