...
// properties or keys. Let us take a look at a very simple example:
...
// each of which map to a specific value. If we wanted to know the number of followers
// FCC_User has, we can access that property by writing:
...
// This is because the brackets actually allow us to pass a variable in to be 
// evaluated as a property name 
// (hint: keep this in mind for later!). 
// Had we passed followers in without the quotes, the JavaScript engine would have
// attempted to evaluate it as a variable, 
...
// We have created a foods object with three entries. 
// Add three more entries: 
// bananas with a value of 13, 
// grapes with a value of 35, 
